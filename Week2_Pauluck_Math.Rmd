...
If eye colors of male respondents appear independent of their partners', then as an example, the following will be true:
P(Male Blue Eyes and Partner Female Brown Eyes) = P(Male Blue Eyes) * P(Partner Female Brown Eyes)
The probabilies are computere in R
